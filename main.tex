...
The first crystal structure of the Sars-cov-2 $M_{pro}$ became available in February \cite{Zhang409}, it showed an extremely similar structure to the Sars-Cov $M_{pro}$ (PDB entry 2BX4)\cite{tan2005ph} at 0.53 Å RMSD for all Ca and has a 96\% sequence identity. 
