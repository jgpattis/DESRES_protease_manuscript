...
The monomeric $M_{pro}$ is not active, only the dimer is active. Furthermore in Sars-Cov there has also been some evidence that in the dimer only one monomer is active at a time. 
