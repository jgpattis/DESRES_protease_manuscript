...
\begin{figure}[ic1vic2-colortime]
\centering
\graphicspath{https://github.com/jgpattis/Desres-sars-cov-2-apo-mpro/blob/master/tica_plots_06/fdis/}
\includegraphics[width=0.6\linewidth]{fdiscolortime_ic2.pdf}
...
\begin{figure}[ic1vic3-colortime]
\centering
\includegraphics[width=0.6\linewidth]{example-image}
